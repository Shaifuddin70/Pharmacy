...
$generic = $result['generic_id'];
$medicine = $result['medicine_id'];
$unit = $result['unit'];
$invoice = mysqli_fetch_array(mysqli_query($conn, "SELECT medicine_generic.generic_name,medicine_brand.brand_name,medicine.medicine_name,order_table.unit 
FROM order_table 
          ...
          <div class="row">
            <div class="col-12">
              <div class="text-center text-150">
                ...
                <span class="text-default-d3">Warden Tech. Ltd.</span>
              </div>
            </div>
          </div>
          <!-- .row -->
              ...
              <div class="table-responsive">
                <table class="table table-striped table-borderless border-0 border-b-2 brc-default-l1">
                  ...
                  <tbody class="text-95 text-secondary-d3">
                    <tr></tr>
                    <tr>
                      <td><?php echo $invoice['brand_name']; ?></td>
                      <td><?php echo $invoice['generic_name']; ?></td>
                      <td><?php echo $invoice['medicine_name']; ?></td>
