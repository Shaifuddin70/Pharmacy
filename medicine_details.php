...
$query = "SELECT m.medicine_id,c.catagory_name, m.medicine_name, b.brand_name, g.generic_name, m.unit_price, DATE(m.expiry_date) AS expiry_date FROM medicine m 
...
<div class="container">
    <div class="title">
        <span class="text">All Medicine</span>
        <a href="add_medicine.php" class="text"><button class="btn btn-primary" style="position: relative; left: 700px;"> Add Medicine</button> </i></a>
    </div>
