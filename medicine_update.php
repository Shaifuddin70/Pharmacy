        ...
        <div class="container mt-3">
            <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control " required="true" name="unit_price" id="unit_price" value="<?php echo $medicine['unit_price']; ?>"></td>
                </tr>
                <tr>
                    <td><label for="expiry_date">Expiry Date:</label></td>
                    <td><input type="date" class="form-control " required="true" name="expiry_date" id="expiry_date" value="<?php echo $medicine['expiry_date']; ?>"></td>
                </tr>
            </table>
            <div class="button">
...
if (isset($_POST['update'])) {
    ...
    // Update query
    $update_query = "UPDATE medicine SET medicine_name = '$medicine_name',catagory_id='$catagory_id', brand_id = $brand_id, generic_id = $generic_id, unit_price = $unit_price, expiry_date = '$expiry_date' WHERE medicine_id = $updateid";
